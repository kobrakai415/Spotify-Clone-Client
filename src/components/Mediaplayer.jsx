...
const mapDispatchToProps = (dispatch) => ({
    playSong: (song) => { dispatch(setCurrentSong(song)) }
    ...
    return (
        <>
            <Col xs={5} md={4} className="media-left d-flex align-items-center ">
                ...
                <img height="40px" width="40px" src={props.currentSong.playingNow.track?.album.images[2].url || "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Image_created_with_a_mobile_phone.png/1200px-Image_created_with_a_mobile_phone.png"} alt="song-cover" />

                <div className="d-flex flex-column ms-3">
                    <span className="text-truncate">{props.currentSong.playingNow.track?.name}</span>
                    <small className="text-muted text-truncate">{props.currentSong.playingNow.track?.artists[0].name}</small>
                </div>
            ...
            <Col xs={7} md={5} className="d-flex flex-column media-mid">
                <div className="d-flex align-items-center m-auto">
                    ...
                    <div id="play-button" className="d-flex justify-content-center align-items-center">
                        ...
                        <svg id="play" onClick={play} role="img" height="16" width="16" viewBox="0 0 16 16" className="Svg-ulyrgf-0 cMigZB"><path fill="black" d="M4.018 14L14.41 8 4.018 2z"></path></svg></div>
                ...
                <div className="d-flex align-items-center">
                    ...
                    <div className="mx-3 progress-bar" style={{ height: "2px", width: "90%", backgroundColor: "#b3b3b3" }} role="progressbar" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100}>
                        <audio id="audio">
                        <source src={props.currentSong.playingNow.track?.preview_url} type="audio/mpeg"></source>
                        {/* <source src="https://cdns-preview-9.dzcdn.net/stream/c-9990cd5b96f85daf3f3dc57ed801a899-6.mp3" type="audio/mpeg"></source> */}
                        {/* <source src="https://www.computerhope.com/jargon/m/example.mp3" type="audio/mpeg"></source> */}
