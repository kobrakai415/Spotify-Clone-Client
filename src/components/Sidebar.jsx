...
const Sidebar = () => {
    ...
    return (
        <Col className="sidebar pt-1" xs={12} md={3} lg={2}>
            ...
            <div className="sidebar-buttons d-flex flex-row flex-md-column justify-content-between">
                ...
                <Link onClick={() => setSelected("Home")} className={selected === "Home" ? "selected p-2" : "p-2"} to="/"> <svg className="me-md-2" viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link onClick={() => setSelected("Search")} className={selected === "Search" ? "selected p-2" : "p-2"} to="/search" ><svg className="me-md-2" viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link onClick={() => setSelected("Library")} className={selected === "Library" ? "selected p-2" : "p-2"} to="/library"><svg className="me-md-2" viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
