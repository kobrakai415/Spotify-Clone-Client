    ...
    render() {
        return (
            <Col className="sidebar" xs={12} md={3} lg={2}>
                <div className="px-1 py-3 d-none d-md-block ">
                ...
                <div className="sidebar-buttons d-flex flex-row flex-md-column justify-content-between">
                    ...
                    <a className="p-2" href="/"> <svg className="me-2" viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
