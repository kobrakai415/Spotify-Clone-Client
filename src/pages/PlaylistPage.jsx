            ...
            <Row className="mx-0">
                ...
                <Col xs={12} className="mt-5">
                    ...
                    <Row className="mx-0 p-2">
                        ...
                        <div className="col-7 col-md-5 col-lg-4">Title</div>
                        <div className="d-none d-lg-block col-lg-4">Album</div>
                        <div className="d-none d-md-block col-md-4 col-lg-2">Date Added</div>

                        <div className="col-3 col-md-2 col-lg-1" >
                            <svg className="mx-2" width="16" height="16" viewBox="0 0 16 16" fill="none">
